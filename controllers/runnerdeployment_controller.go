...
func (r *RunnerDeploymentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	r.Recorder = mgr.GetEventRecorderFor("runnerdeployment-controller")

	if err := mgr.GetFieldIndexer().IndexField(ctx, &v1alpha1.RunnerReplicaSet{}, runnerSetOwnerKey, func(rawObj client.Object) []string {
